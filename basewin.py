...
class baseMainWindow ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_staticline1 = wx.StaticLine( self.video_panel, wx.ID_ANY, wx.DefaultPosition, wx.Size( 533,-1 ), 0 )
		...
		gbSizer31.Add( self.fetch_button, wx.GBPosition( 0, 1 ), wx.GBSpan( 1, 1 ), wx.ALIGN_CENTER_VERTICAL|wx.LEFT, 10 )
		
		self.m_staticText4 = wx.StaticText( self.video_panel, wx.ID_ANY, u"注: 合并视频\n需要ffmpeg", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText4.Wrap( -1 )
		gbSizer31.Add( self.m_staticText4, wx.GBPosition( 1, 1 ), wx.GBSpan( 1, 1 ), wx.ALIGN_CENTER_HORIZONTAL|wx.LEFT, 10 )
		...
		self.location_lable_staticText = wx.StaticText( self, wx.ID_ANY, u"保存位置：", wx.DefaultPosition, wx.Size( 70,-1 ), 0 )
		...
		self.save_local_dirPicker = wx.DirPickerCtrl( self, wx.ID_ANY, wx.EmptyString, u"Select a folder", wx.DefaultPosition, wx.Size( 467,-1 ), wx.DIRP_DEFAULT_STYLE )
		...
		bSizer9.Add( gbSizer2, 0, wx.ALIGN_CENTER_HORIZONTAL|wx.EXPAND, 0 )
		
		gbSizer3 = wx.GridBagSizer( 0, 0 )
		gbSizer3.SetFlexibleDirection( wx.BOTH )
		gbSizer3.SetNonFlexibleGrowMode( wx.FLEX_GROWMODE_SPECIFIED )
		
		self.proxy_checkBox = wx.CheckBox( self, wx.ID_ANY, u"Proxy:", wx.DefaultPosition, wx.Size( 60,-1 ), 0 )
		self.proxy_checkBox.SetValue(True) 
		self.proxy_checkBox.SetForegroundColour( wx.Colour( 0, 0, 0 ) )
		
		gbSizer3.Add( self.proxy_checkBox, wx.GBPosition( 0, 1 ), wx.GBSpan( 1, 1 ), wx.TOP, 3 )
		
		
		gbSizer3.Add( ( 209, 0 ), wx.GBPosition( 0, 0 ), wx.GBSpan( 1, 1 ), wx.EXPAND, 5 )
		
		self.proxy_textCtrl = wx.TextCtrl( self, wx.ID_ANY, u"socks5://127.0.0.1:1080/", wx.Point( -1,-1 ), wx.Size( 180,-1 ), 0 )
		gbSizer3.Add( self.proxy_textCtrl, wx.GBPosition( 0, 2 ), wx.GBSpan( 1, 1 ), wx.TOP, 1 )
		
		self.stop_button = wx.Button( self, wx.ID_ANY, u"暂停", wx.DefaultPosition, wx.Size( -1,25 ), 0 )
		gbSizer3.Add( self.stop_button, wx.GBPosition( 1, 3 ), wx.GBSpan( 1, 1 ), wx.LEFT|wx.TOP, 5 )
		
		self.download_button = wx.Button( self, wx.ID_ANY, u"开始下载", wx.Point( -1,-1 ), wx.Size( -1,25 ), 0 )
		gbSizer3.Add( self.download_button, wx.GBPosition( 0, 3 ), wx.GBSpan( 1, 1 ), wx.LEFT, 5 )
		
		
		bSizer9.Add( gbSizer3, 1, wx.ALIGN_CENTER_HORIZONTAL|wx.ALL|wx.SHAPED, 10 )
